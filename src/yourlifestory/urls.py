...
urlpatterns = [
    ...
    path("curriculums/", include(("curriculum.urls", "curriculum"), namespace="curriculum")),
    path("journal/", include(("journal.urls", "journal"), namespace="journal")),
    path("posts/", core_views.MyPostListView.as_view(), name="post-list"),
    path("posts/create/", core_views.PostCreateView.as_view(), name="post-create"),
    path("posts/<int:pk>/", core_views.PostDetailView.as_view(), name="post-detail"),
    path("posts/<int:pk>/edit/", core_views.PostUpdateView.as_view(), name="post-edit"),
    path("posts/<int:pk>/delete/", core_views.PostDeleteView.as_view(), name="post-delete"),
    ...
    path("publications/<int:pk>/download/", publication_views.PublicationDownloadView.as_view(), name="publication-download"),
